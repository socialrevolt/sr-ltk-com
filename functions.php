...
if ( function_exists( 'add_theme_support' ) ) {
    ...
    add_image_size( 'post-featured-image', 700, 400, true ); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
function html5_blank_view_article( $more ) {
    global $post;
    return '... <a class="view-article" href="' . get_permalink( $post->ID ) . '">' . esc_html_e( '', 'html5blank' ) . '</a>';
}
...
function my_admin_menu() {
    add_menu_page( 'LTK Generator', 'LTK Generator', 'manage_options', 'ltk-generator/ltk-generator-admin-page.php', 'myplguin_admin_page', 'dashicons-tickets', 6  );
}
...
function make_ad_posttype() {
    ...
    $labels = array(
        ...
        'archives'              => __( 'Advertisements', 'text_domain' ),
    ...
    $args = array(
        ...
        'description'           => __( 'Used for advertisements displayed on the website', 'text_domain' ),
        'labels'                => $labels,
    ...
    register_post_type( 'rs_advertisement', $args );
